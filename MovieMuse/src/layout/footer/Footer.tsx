      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3 mb-4">
            <img src="Img/Full logo.png" alt="Logo" className="img-fluid mb-2" style={{ width: '200px', height: '70px' }} />
            <p className="text-secondary">Discover films that move you</p>
          </div>

          {/* Links */}
          <div className="col-md-3 mb-4">
            <h5 className="text-warning fw-bold">Home</h5>
          ...
          {/* Contact */}
          <div className="col-md-3 mb-4">
            <h5 className="text-warning fw-bold">Contact</h5>
          ...
          {/* Newsletter */}
          <div className="col-md-3 mb-4">
            <h5 className="text-warning fw-bold">Signup</h5>
            <p className="text-secondary">Start your journey now</p>
            <form className="d-flex flex-column flex-sm-row gap-2 mt-2">
              <input type="email" className="form-control" placeholder="Your email" />
              <button className="btn btn-warning text-white" type="submit">Signup</button>
            </form>
          </div>
        </div>

        {/* Footer Bottom */}
        <div className="text-center pt-4 border-top border-warning mt-4">
          <div className="mb-3">
          ...
          <p className="text-secondary small mb-0">
            &copy; 2025 MovieMuse. All rights reserved. | <a href="#" className="text-warning text-decoration-none">Privacy Policy</a>
          </p>
        </div>
      </div>
    </footer>
